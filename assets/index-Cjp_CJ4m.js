 ...
 */var dl=Symbol.for("react.element"),j_=Symbol.for("react.portal"),X_=Symbol.for("react.fragment"),$_=Symbol.for("react.strict_mode"),Y_=Symbol.for("react.profiler"),q_=Symbol.for("react.provider"),Z_=Symbol.for("react.context"),K_=Symbol.for("react.forward_ref"),J_=Symbol.for("react.suspense"),Q_=Symbol.for("react.memo"),ey=Symbol.for("react.lazy"),Fp=Symbol.iterator;function ty(t){return t===null||typeof t!="object"?null:(t=Fp&&t[Fp]||t["@@iterator"],typeof t=="function"?t:null)}var N0={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},I0=Object.assign,D0={};function $o(t,e,n){this.props=t,this.context=e,this.refs=D0,this.updater=n||N0}$o.prototype.isReactComponent={};$o.prototype.setState=function(t,e){if(typeof t!="object"&&typeof t!="function"&&t!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,t,e,"setState")};$o.prototype.forceUpdate=function(t){this.updater.enqueueForceUpdate(this,t,"forceUpdate")};function U0(){}U0.prototype=$o.prototype;function vh(t,e,n){this.props=t,this.context=e,this.refs=D0,this.updater=n||N0}var xh=vh.prototype=new U0;xh.constructor=vh;I0(xh,$o.prototype);xh.isPureReactComponent=!0;var kp=Array.isArray,O0=Object.prototype.hasOwnProperty,_h={current:null},F0={key:!0,ref:!0,__self:!0,__source:!0};function k0(t,e,n){var i,r={},s=null,o=null;if(e!=null)for(i in e.ref!==void 0&&(o=e.ref),e.key!==void 0&&(s=""+e.key),e)O0.call(e,i)&&!F0.hasOwnProperty(i)&&(r[i]=e[i]);var a=arguments.length-2;if(a===1)r.children=n;else if(1<a){for(var l=Array(a),c=0;c<a;c++)l[c]=arguments[c+2];r.children=l}if(t&&t.defaultProps)for(i in a=t.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:dl,type:t,key:s,ref:o,props:r,_owner:_h.current}}function ny(t,e){return{$$typeof:dl,type:t.type,key:e,ref:t.ref,props:t.props,_owner:t._owner}}function yh(t){return typeof t=="object"&&t!==null&&t.$$typeof===dl}function iy(t){var e={"=":"=0",":":"=2"};return"$"+t.replace(/[=:]/g,function(n){return e[n]})}var zp=/\/+/g;function Xu(t,e){return typeof t=="object"&&t!==null&&t.key!=null?iy(""+t.key):e.toString(36)}function yc(t,e,n,i,r){var s=typeof t;(s==="undefined"||s==="boolean")&&(t=null);var o=!1;if(t===null)o=!0;else switch(s){case"string":case"number":o=!0;break;case"object":switch(t.$$typeof){case dl:case j_:o=!0}}if(o)return o=t,r=r(o),t=i===""?"."+Xu(o,0):i,kp(r)?(n="",t!=null&&(n=t.replace(zp,"$&/")+"/"),yc(r,e,n,"",function(c){return c})):r!=null&&(yh(r)&&(r=ny(r,n+(!r.key||o&&o.key===r.key?"":(""+r.key).replace(zp,"$&/")+"/")+t)),e.push(r)),1;if(o=0,i=i===""?".":i+":",kp(t))for(var a=0;a<t.length;a++){s=t[a];var l=i+Xu(s,a);o+=yc(s,e,n,l,r)}else if(l=ty(t),typeof l=="function")for(t=l.call(t),a=0;!(s=t.next()).done;)s=s.value,l=i+Xu(s,a++),o+=yc(s,e,n,l,r);else if(s==="object")throw e=String(t),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.");return o}function Tl(t,e,n){if(t==null)return t;var i=[],r=0;return yc(t,i,"","",function(s){return e.call(n,s,r++)}),i}function ry(t){if(t._status===-1){var e=t._result;e=e(),e.then(function(n){(t._status===0||t._status===-1)&&(t._status=1,t._result=n)},function(n){(t._status===0||t._status===-1)&&(t._status=2,t._result=n)}),t._status===-1&&(t._status=0,t._result=e)}if(t._status===1)return t._result.default;throw t._result}var Yn={current:null},Sc={transition:null},sy={ReactCurrentDispatcher:Yn,ReactCurrentBatchConfig:Sc,ReactCurrentOwner:_h};function z0(){throw Error("act(...) is not supported in production builds of React.")}bt.Children={map:Tl,forEach:function(t,e,n){Tl(t,function(){e.apply(this,arguments)},n)},count:function(t){var e=0;return Tl(t,function(){e++}),e},toArray:function(t){return Tl(t,function(e){return e})||[]},only:function(t){if(!yh(t))throw Error("React.Children.only expected to receive a single React element child.");return t}};bt.Component=$o;bt.Fragment=X_;bt.Profiler=Y_;bt.PureComponent=vh;bt.StrictMode=$_;bt.Suspense=J_;bt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=sy;bt.act=z0;bt.cloneElement=function(t,e,n){if(t==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+t+".");var i=I0({},t.props),r=t.key,s=t.ref,o=t._owner;if(e!=null){if(e.ref!==void 0&&(s=e.ref,o=_h.current),e.key!==void 0&&(r=""+e.key),t.type&&t.type.defaultProps)var a=t.type.defaultProps;for(l in e)O0.call(e,l)&&!F0.hasOwnProperty(l)&&(i[l]=e[l]===void 0&&a!==void 0?a[l]:e[l])}var l=arguments.length-2;if(l===1)i.children=n;else if(1<l){a=Array(l);for(var c=0;c<l;c++)a[c]=arguments[c+2];i.children=a}return{$$typeof:dl,type:t.type,key:r,ref:s,props:i,_owner:o}};bt.createContext=function(t){return t={$$typeof:Z_,_currentValue:t,_currentValue2:t,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},t.Provider={$$typeof:q_,_context:t},t.Consumer=t};bt.createElement=k0;bt.createFactory=function(t){var e=k0.bind(null,t);return e.type=t,e};bt.createRef=function(){return{current:null}};bt.forwardRef=function(t){return{$$typeof:K_,render:t}};bt.isValidElement=yh;bt.lazy=function(t){return{$$typeof:ey,_payload:{_status:-1,_result:t},_init:ry}};bt.memo=function(t,e){return{$$typeof:Q_,type:t,compare:e===void 0?null:e}};bt.startTransition=function(t){var e=Sc.transition;Sc.transition={};try{t()}finally{Sc.transition=e}};bt.unstable_act=z0;bt.useCallback=function(t,e){return Yn.current.useCallback(t,e)};bt.useContext=function(t){return Yn.current.useContext(t)};bt.useDebugValue=function(){};bt.useDeferredValue=function(t){return Yn.current.useDeferredValue(t)};bt.useEffect=function(t,e){return Yn.current.useEffect(t,e)};bt.useId=function(){return Yn.current.useId()};bt.useImperativeHandle=function(t,e,n){return Yn.current.useImperativeHandle(t,e,n)};bt.useInsertionEffect=function(t,e){return Yn.current.useInsertionEffect(t,e)};bt.useLayoutEffect=function(t,e){return Yn.current.useLayoutEffect(t,e)};bt.useMemo=function(t,e){return Yn.current.useMemo(t,e)};bt.useReducer=function(t,e,n){return Yn.current.useReducer(t,e,n)};bt.useRef=function(t){return Yn.current.useRef(t)};bt.useState=function(t){return Yn.current.useState(t)};bt.useSyncExternalStore=function(t,e,n){return Yn.current.useSyncExternalStore(t,e,n)};bt.useTransition=function(){return Yn.current.useTransition()};bt.version="18.3.1";L0.exports=bt;var Oe=L0.exports;const oy=W_(Oe);/**
 * @license React
...
#endif`,Lw="gl_FragColor = linearToOutputTexel( gl_FragColor );",Nw=`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const IA=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]],A0=dn("Image",IA);/**
 * @license lucide-react v0.482.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oC=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],sf=dn("X",oC),fo=()=>Math.random().toString(36).substr(2,9),bn={camera:["#3b82f6","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899"],building:["#cbd5e1","#94a3b8","#64748b","#475569","#334155","#1e293b"],tree:["#22c55e","#16a34a","#15803d","#14532d","#84cc16","#bef264"],parking:["#e2e8f0","#cbd5e1","#94a3b8","#f8fafc","#ffffff","#f1f5f9"],label:["#1e293b","#334155","#475569","#64748b","#ef4444","#3b82f6"]},of={width:1e3,height:700},Jn=(t,e,n)=>Math.min(Math.max(t,e),n),af=t=>{let e=t%360;return e>180&&(e-=360),e<-180&&(e+=360),e},_c=(t,e)=>[{x:-t/2,y:-e/2},{x:t/2,y:-e/2},{x:t/2,y:e/2},{x:-t/2,y:e/2}],aC=t=>{const e=t.map(a=>a.x),n=t.map(a=>a.y),i=Math.min(...e),r=Math.max(...e),s=Math.min(...n),o=Math.max(...n);return{minX:i,maxX:r,minY:s,maxY:o,width:r-i,height:o-s}},lf=t=>{const e=new zr,n=t.width,i=t.height,r=12,s=3,o=t.color,l=t.id.split("").reduce((X,te)=>X+te.charCodeAt(0),0)%4,c=new cn({color:o,roughness:.2,metalness:.3,flatShading:!0}),u=new cn({color:"#1e293b",roughness:.1,metalness:.9,flatShading:!0}),f=new cn({color:"#171717",roughness:.5,flatShading:!0}),h=new Ns(s,s,n*.15,12);h.rotateZ(Math.PI/2);const p=i*.35,v=n*.45;(()=>{[-1,1].forEach(X=>{[-1,1].forEach(te=>{const I=new Ye(h,f);I.position.set(X*v,s,te*p),I.castShadow=!0,e.add(I)})})})();const g=s+1;if(l===1){const X=r*.9,te=new Ye(new ln(n,X,i),c);te.position.y=g+X/2,te.castShadow=!0,te.receiveShadow=!0,e.add(te);const I=r*.7,W=i*.8,j=n*.85,ee=new Ye(new ln(j,I,W),c);ee.position.y=g+X+I/2-2,ee.castShadow=!0,e.add(ee);const z=new Ye(new ln(j+.2,I*.7,W*.9),u);z.position.copy(ee.position),e.add(z)}else if(l===2){const X=i*.35,te=i*.6,I=r*1.5,W=new Ye(new ln(n,r*.6,i),c);W.position.y=g+r*.3,W.castShadow=!0,e.add(W);const j=new Ye(new ln(n*.95,I,X),c);j.position.set(0,g+r*.3+I/2,-i/2+X/2+2),j.castShadow=!0,e.add(j);const ee=new Ye(new ln(n+.1,I*.5,X*.7),u);ee.position.copy(j.position),ee.position.y+=2,e.add(ee);const z=4,$=new Ye(new ln(n*.95,z,te),c);$.position.set(0,g+r*.6+z/2,i/2-te/2),e.add($)}else if(l===3){const X=r*.7,te=new Ye(new ln(n,X,i),c);te.position.y=g+X/2,te.castShadow=!0,e.add(te);const I=r*.5,W=i*.5,j=new Ye(new ln(n*.7,I,W),c);j.position.y=g+X+I/2-1,e.add(j);const ee=new Ye(new ln(n*.72,I*.8,W*.8),u);ee.position.copy(j.position),e.add(ee)}else{const X=r*.6,te=new Ye(new ln(n,X,i),c);te.position.y=g+X/2,te.castShadow=!0,e.add(te);const I=r*.8,W=i*.5,j=new Ye(new ln(n*.85,I,W),c);j.position.y=g+X+I/2-1,j.castShadow=!0,e.add(j);const ee=new Ye(new ln(n*.9,I*.8,W*.9),u);ee.position.copy(j.position),e.add(ee)}const d=new xi(3,2),m=new Ji({color:"#fef3c7"}),x=new Ji({color:"#ef4444"}),S=-i/2-.1,L=i/2+.1,A=g+r*.6,R=n*.35,F=new Ye(d,m);F.position.set(-R,A,S),F.rotation.y=Math.PI,e.add(F);const E=new Ye(d,m);E.position.set(R,A,S),E.rotation.y=Math.PI,e.add(E);const T=new Ye(d,x);T.position.set(-R,A,L),e.add(T);const V=new Ye(d,x);return V.position.set(R,A,L),e.add(V),e.position.set(t.x,0,t.y),e.rotation.y=-Un.degToRad(t.rotation),e},cf=t=>{const e=new zr,n=t.id.split("").reduce((f,h)=>f+h.charCodeAt(0),0),i=n%2===0,r=t.radius*.25,s=i?t.radius*2:t.radius*1.5,o=new Ns(r*.6,r,s,6),a=new cn({color:"#4a3728",roughness:1,flatShading:!0}),l=new Ye(o,a);l.position.y=s/2,l.castShadow=!0,l.receiveShadow=!0,e.add(l);const c=i?"#1e4620":t.color,u=new cn({color:c,roughness:.8,flatShading:!0});if(i){const h=t.radius,p=t.radius*2.5/4;for(let v=0;v<4;v++){const y=v/3,g=h*(1-y*.6),d=s*.3+v*(p*.8),m=new Ye(new wp(g,p*1.5,7),u);m.position.y=d,m.castShadow=!0,m.receiveShadow=!0,e.add(m)}}else{const f=new hu(t.radius*.8,0),h=new Ye(f,u);h.position.y=s+t.radius*.2,h.castShadow=!0,h.receiveShadow=!0,e.add(h);const p=10;for(let v=0;v<p;v++){const g=(n+v*13)%100/100*Math.PI*2,d=(n+v*7)%100/100*Math.PI,m=t.radius*(.3+(n+v*3)%5/10),x=t.radius*.7,S=new Ye(new hu(m,0),u);S.position.set(Math.sin(d)*Math.cos(g)*x,h.position.y+Math.cos(d)*x*.8,Math.sin(d)*Math.sin(g)*x),S.castShadow=!0,e.add(S)}}return e.position.set(t.x,0,t.y),e},lC=(t,e,n)=>{const i=aC(t);if(i.width===0||i.height===0)return t;const r={x:(i.minX+i.maxX)/2,y:(i.minY+i.maxY)/2},s=e/i.width,o=n/i.height;return t.map(a=>({x:r.x+(a.x-r.x)*s,y:r.y+(a.y-r.y)*o}))},cC=t=>{if(t.length<2)return t;let e=0,n=0;for(let o=0;o<t.length;o+=1){const a=(o+1)%t.length,l=t[a].x-t[o].x,c=t[a].y-t[o].y,u=Math.hypot(l,c);u>n&&(n=u,e=o)}const i=(e+1)%t.length,r={x:(t[e].x+t[i].x)/2,y:(t[e].y+t[i].y)/2},s=[...t];return s.splice(e+1,0,r),s},uC=(t,e)=>{if(t.length<2)return t;let n=0,i=Number.POSITIVE_INFINITY,r=e;for(let o=0;o<t.length;o+=1){const a=(o+1)%t.length,l=t[o],c=t[a],u={x:c.x-l.x,y:c.y-l.y},f={x:e.x-l.x,y:e.y-l.y},h=u.x*u.x+u.y*u.y||1;let p=(f.x*u.x+f.y*u.y)/h;p=Jn(p,0,1);const v={x:l.x+u.x*p,y:l.y+u.y*p},y=Math.hypot(e.x-v.x,e.y-v.y);y<i&&(i=y,n=o+1,r=v)}const s=[...t];return s.splice(n,0,r),s},dC=(t,e)=>{const n=t.replace("#",""),i=n.length===3?n.split("").map(l=>l+l).join(""):n,r=parseInt(i,16),s=Jn((r>>16)+e,0,255),o=Jn((r>>8&255)+e,0,255),a=Jn((r&255)+e,0,255);return`#${(s<<16|o<<8|a).toString(16).padStart(6,"0")}`},fC=(t,e)=>{const n=t*Math.PI/180,i=2*Math.atan(Math.tan(n/2)/Math.sqrt(e*e+1));return{h:2*Math.atan(Math.tan(i/2)*e)*180/Math.PI,v:i*180/Math.PI}},hC=(t,e)=>{const n=t*Math.PI/180,i=e*Math.PI/180;return 2*Math.atan(Math.sqrt(Math.tan(n/2)**2+Math.tan(i/2)**2))*180/Math.PI},xa=(t,e)=>{const n=t*Math.PI/180;return 2*Math.atan(Math.tan(n/2)/e)*180/Math.PI},pC=(t,e)=>{const n=t*Math.PI/180;return 2*Math.atan(Math.tan(n/2)*e)*180/Math.PI};function mC(){var Lp,Np,Ip,Dp,Up,Op;const[t,e]=Oe.useState([]),[n,i]=Oe.useState(null),r=Oe.useRef(null);Oe.useEffect(()=>{r.current=n},[n]);const[s,o]=Oe.useState([]),[a,l]=Oe.useState(-1),c=Oe.useRef([]),u=Oe.useRef(-1);Oe.useEffect(()=>{c.current=s,u.current=a},[s,a]);const f=()=>{const _=JSON.stringify(t);a>=0&&s[a]===_||(o(b=>{const N=b.slice(0,a+1);return N.push(_),N.length>30&&N.shift(),N}),l(b=>{const N=b+1;return N>=30?29:N}))},h=()=>{const _=u.current;if(_>0){const b=_-1;try{const N=JSON.parse(c.current[b]);e(N),l(b)}catch(N){console.error("Undo failed",N)}}},p=()=>{const _=u.current;if(_<c.current.length-1){const b=_+1;try{const N=JSON.parse(c.current[b]);e(N),l(b)}catch(N){console.error("Redo failed",N)}}},[v,y]=Oe.useState(of),[g,d]=Oe.useState(null),[m,x]=Oe.useState({x:0,y:0,width:of.width,height:of.height,opacity:.5}),[S,L]=Oe.useState(20),[A,R]=Oe.useState(!0),[F,E]=Oe.useState(!0),[T,V]=Oe.useState("Security Camera Plan"),[X,te]=Oe.useState(!1),[I,W]=Oe.useState("plan"),[j,ee]=Oe.useState({scale:2,padding:48,includeGrid:!0,includeLegend:!0,includeTitle:!0,includeCameraViews:!0}),[z,$]=Oe.useState({x:0,y:0}),[Y,le]=Oe.useState(1),[de,J]=Oe.useState(!1),[ue,Pe]=Oe.useState({x:0,y:0,panX:0,panY:0}),[Be,Ie]=Oe.useState(!1),st=Oe.useRef(!1),[tt,Xe]=Oe.useState("select"),[He,D]=Oe.useState(null),[re,ae]=Oe.useState({type:null,itemId:null,startMouse:{x:0,y:0},startVal:null,snap:!1}),he=Oe.useRef(null),se=Oe.useRef(null),Je=Oe.useRef(null),De=Oe.useRef(null),C=Oe.useRef(null),w=Oe.useRef(null),H=Oe.useRef(null),[me,ge]=Oe.useState([]),[fe,je]=Oe.useState(!1),[Ae,ze]=Oe.useState(!0),[Ue,lt]=Oe.useState([]),[ne,Et]=Oe.useState({visible:!0,opacity:.15,edgeOpacity:.6,useCameraColor:!0,color:"#3b82f6",showAll:!0,mode:"volume"}),[ct,dt]=Oe.useState(null),[$e,Ve]=Oe.useState("flat"),[nt,Ct]=Oe.useState(null);Oe.useEffect(()=>{const _=localStorage.getItem("securityCameraPlannerData");if(_)try{const b=JSON.parse(_);b.items&&e(b.items),b.backgroundImg&&d(b.backgroundImg),b.bgSettings&&x(b.bgSettings),b.canvasSize&&y(b.canvasSize),b.exportList&&lt(b.exportList),b.projectName&&V(b.projectName),b.frustumSettings&&Et(b.frustumSettings),b.sceneBackgroundImg&&dt(b.sceneBackgroundImg),b.backgroundMode&&Ve(b.backgroundMode)}catch(b){console.error("Failed to load saved state",b)}},[]),Oe.useEffect(()=>{const _=setTimeout(()=>{try{const b={items:t,backgroundImg:g,bgSettings:m,canvasSize:v,exportList:Ue,projectName:T,frustumSettings:ne,sceneBackgroundImg:ct,backgroundMode:$e};localStorage.setItem("securityCameraPlannerData",JSON.stringify(b))}catch(b){if(b.name==="QuotaExceededError"||b.name==="NS_ERROR_DOM_QUOTA_REACHED"){console.error("Storage full, trying to save without background image");try{const N={items:t,bgSettings:m,canvasSize:v,exportList:Ue,projectName:T};localStorage.setItem("securityCameraPlannerData",JSON.stringify(N))}catch(N){console.error("Still failed to save",N)}}else console.error("Failed to save state",b)}},1e3);return()=>clearTimeout(_)},[t,g,m,v,Ue,T,ne,ct,$e]);const zt=Oe.useRef(null),pt=Oe.useRef(null),Te=(_,b=F)=>b?Math.round(_/S)*S:_,O=_=>_.points&&_.points.length>=3?_.points:_c(_.width,_.height),Le=(_,b)=>{const N=b*Math.PI/180,B=Math.cos(N),k=Math.sin(N);return{x:_.x*B-_.y*k,y:_.x*k+_.y*B}},Ne=(_,b)=>{const N=Le(_,b.rotation);return{x:b.x+N.x,y:b.y+N.y}},at=(_,b)=>{const N=_.x-b.x,B=_.y-b.y;return Le({x:N,y:B},-b.rotation)},rt=_=>t.find(b=>b.type==="building"&&b.id===_),Rt=_=>O(_).map(N=>Ne(N,_)),At=_=>{var b;if(((b=_.mount)==null?void 0:b.type)==="building"&&_.mount.buildingId){const N=rt(_.mount.buildingId);if(!N)return{x:_.x,y:_.y};const B=Rt(N);if(B.length<2)return{x:_.x,y:_.y};const k=Jn(_.mount.edgeIndex??0,0,B.length-1),oe=(k+1)%B.length,Q=B[k],ie=B[oe],xe=Jn(_.mount.edgeT??.5,0,1),pe={x:Q.x+(ie.x-Q.x)*xe,y:Q.y+(ie.y-Q.y)*xe},Ee=B.reduce((be,ce)=>({x:be.x+ce.x,y:be.y+ce.y}),{x:0,y:0});B.length>0&&(Ee.x/=B.length,Ee.y/=B.length);const Ge={x:pe.x-Ee.x,y:pe.y-Ee.y},qe=Math.hypot(Ge.x,Ge.y)||1,ve=3;return{x:pe.x+Ge.x/qe*ve,y:pe.y+Ge.y/qe*ve}}return{x:_.x,y:_.y}},sn=_=>{let b=null;return t.forEach(N=>{if(N.type!=="building")return;const B=N,k=Rt(B);for(let oe=0;oe<k.length;oe+=1){const Q=(oe+1)%k.length,ie=k[oe],xe=k[Q],pe={x:xe.x-ie.x,y:xe.y-ie.y},Ee={x:_.x-ie.x,y:_.y-ie.y},Ge=pe.x*pe.x+pe.y*pe.y||1;let qe=(Ee.x*pe.x+Ee.y*pe.y)/Ge;qe=Jn(qe,0,1);const ve={x:ie.x+pe.x*qe,y:ie.y+pe.y*qe},be=Math.hypot(_.x-ve.x,_.y-ve.y);(!b||be<b.distance)&&(b={buildingId:B.id,edgeIndex:oe,edgeT:qe,distance:be,point:ve})}}),b},vn=_=>{let b=null;return t.forEach(N=>{if(N.type!=="building")return;const B=N,k=Rt(B),oe={x:k.reduce((Q,ie)=>Q+ie.x,0)/k.length,y:k.reduce((Q,ie)=>Q+ie.y,0)/k.length};for(let Q=0;Q<k.length;Q+=1){const ie=(Q+1)%k.length,xe=k[Q],pe=k[ie],Ee={x:pe.x-xe.x,y:pe.y-xe.y},Ge={x:_.x-xe.x,y:_.y-xe.y},qe=Ee.x*Ee.x+Ee.y*Ee.y||1;let ve=(Ge.x*Ee.x+Ge.y*Ee.y)/qe;ve=Jn(ve,0,1);const be={x:xe.x+Ee.x*ve,y:xe.y+Ee.y*ve},ce=Math.hypot(_.x-be.x,_.y-be.y),Re={x:(xe.x+pe.x)/2,y:(xe.y+pe.y)/2},ye={x:Re.x-oe.x,y:Re.y-oe.y},ke=Math.atan2(ye.y,ye.x)*(180/Math.PI);(!b||ce<b.distance)&&(b={buildingId:B.id,edgeIndex:Q,edgeT:ve,distance:ce,point:be,rotation:ke})}}),b};v.width/2;const Dt=(_,b)=>{if(!he.current||I==="iso3d")return;const N=he.current.getScreenCTM();if(!N)return;const B=Te((_.clientX-N.e)/N.a),k=Te((_.clientY-N.f)/N.d);let oe;const Q={id:fo(),x:B,y:k,rotation:0};switch(b){case"add-camera":oe={...Q,type:"camera",rotation:45,label:"Camera",description:"",fov:70,hFov:70,vFov:45,pitch:-15,height:60,aspect:16/9,mount:{type:"free",edgeT:.5,height:60},range:150,color:bn.camera[0],labelOffset:{x:0,y:30},connectorDashSize:3};break;case"add-building":oe={...Q,type:"building",width:100,height:80,label:"Building",color:bn.building[0],points:_c(100,80)};break;case"add-tree":oe={...Q,type:"tree",radius:25,color:bn.tree[0]};break;case"add-parking":oe={...Q,type:"parking",width:30,height:50,color:bn.parking[0]};break;case"add-label":oe={...Q,type:"label",text:"Label",fontSize:14,color:bn.label[0]};break;default:return}if(oe.type==="camera"){const ie=vn({x:B,y:k});if(ie&&ie.distance<100){const xe=oe;xe.x=ie.point.x,xe.y=ie.point.y,xe.rotation=ie.rotation;const pe=60;xe.mount={type:"building",buildingId:ie.buildingId,edgeIndex:ie.edgeIndex,edgeT:ie.edgeT,height:pe},xe.height=pe}Ct(null)}e([...t,oe]),D(oe.id),Xe("select")},wn=_=>{const b={id:fo(),type:"image",x:400,y:300,rotation:0,width:150,height:150,src:_,label:"Image",aspectRatioLocked:!0};e([...t,b]),D(b.id)},gt=(_,b)=>{e(t.map(N=>N.id===_?{...N,...b}:N))},Fs=(_,b)=>{const N=t.find(B=>B.id===_);!N||N.type!=="camera"||gt(_,{mount:{...N.mount??{type:"free"},...b}})},Ou=_=>{var B;const b=t.find(k=>k.id===_);if(!b||b.type!=="camera")return;const N=sn(b);N&&gt(_,{x:N.point.x,y:N.point.y,mount:{type:"building",buildingId:N.buildingId,edgeIndex:N.edgeIndex,edgeT:N.edgeT,height:((B=b.mount)==null?void 0:B.height)??b.height??10}})},Bi=(_,b,N,B)=>{gt(_,{hFov:b,vFov:N,aspect:B,fov:b})},Jo=(_,b,N)=>{const B=t.find(Q=>Q.id===_);if(!B||B.type!=="building")return;const k=O(B),oe=lC(k,b,N);gt(_,{width:b,height:N,points:oe})},ks=_=>{const b=t.find(B=>B.id===_);if(!b||b.type!=="building")return;const N=cC(O(b));gt(_,{points:N})},Qo=(_,b)=>{const N=t.find(oe=>oe.id===_);if(!N||N.type!=="building")return;const B=at(b,N),k=uC(O(N),B);gt(_,{points:k})},_l=_=>{const b=t.find(B=>B.id===_);if(!b||b.type!=="building")return;const N=O(b);N.length<=3||gt(_,{points:N.slice(0,-1)})},Fu=_=>{const b=t.find(N=>N.id===_);!b||b.type!=="building"||gt(_,{points:_c(b.width,b.height)})},zs=(_,b,N)=>{const B=t.find(oe=>oe.id===_);if(!B||B.type!=="image")return;if(!B.aspectRatioLocked){gt(_,{width:b??B.width,height:N??B.height});return}const k=B.width/B.height;b!==void 0?gt(_,{width:b,height:b/k}):N!==void 0&&gt(_,{width:N*k,height:N})},yl=_=>{e(t.filter(b=>b.id!==_)),He===_&&D(null)},P=()=>{t.length&&window.confirm("Clear all items from the canvas?")&&(e([]),D(null))},G=()=>{x({...m,x:0,y:0,width:v.width,height:v.height})},Z=()=>{if(!he.current)return;const{scale:_,padding:b,includeGrid:N,includeLegend:B,includeTitle:k}=j,oe=new Date().toLocaleString(),Q=v.width,ie=v.height,xe=k?52:0,pe=B?90:0,Ee=Q+b*2,Ge=ie+b*2+xe+pe,qe="http://www.w3.org/2000/svg",ve=document.createElementNS(qe,"svg");ve.setAttribute("xmlns",qe),ve.setAttribute("width",`${Ee}`),ve.setAttribute("height",`${Ge}`),ve.setAttribute("viewBox",`0 0 ${Ee} ${Ge}`);const be=document.createElementNS(qe,"rect");if(be.setAttribute("x","0"),be.setAttribute("y","0"),be.setAttribute("width",`${Ee}`),be.setAttribute("height",`${Ge}`),be.setAttribute("fill","#ffffff"),ve.appendChild(be),k){const Ke=document.createElementNS(qe,"text");Ke.setAttribute("x",`${b}`),Ke.setAttribute("y",`${b+24}`),Ke.setAttribute("font-size","20"),Ke.setAttribute("font-weight","700"),Ke.setAttribute("fill","#0f172a"),Ke.textContent=T||"Security Camera Plan",ve.appendChild(Ke);const mt=document.createElementNS(qe,"text");mt.setAttribute("x",`${b}`),mt.setAttribute("y",`${b+44}`),mt.setAttribute("font-size","12"),mt.setAttribute("fill","#64748b"),mt.textContent=`Exported ${oe}`,ve.appendChild(mt)}const ce=document.createElementNS(qe,"g"),Re=b+xe;ce.setAttribute("transform",`translate(${b}, ${Re})`);const ye=he.current.cloneNode(!0);if(ye.removeAttribute("width"),ye.removeAttribute("height"),!N){const Ke=ye.querySelector("#grid-bg");Ke&&Ke.remove()}for(;ye.childNodes.length>0;)ce.appendChild(ye.childNodes[0]);ve.appendChild(ce);const ke=document.createElementNS(qe,"rect");if(ke.setAttribute("x",`${b-1}`),ke.setAttribute("y",`${Re-1}`),ke.setAttribute("width",`${Q+2}`),ke.setAttribute("height",`${ie+2}`),ke.setAttribute("fill","none"),ke.setAttribute("stroke","#e2e8f0"),ke.setAttribute("stroke-width","2"),ve.appendChild(ke),B){const Ke=Re+ie+36,mt=[{label:"Cameras",count:t.filter(Nt=>Nt.type==="camera").length,color:bn.camera[0]},{label:"Buildings",count:t.filter(Nt=>Nt.type==="building").length,color:bn.building[0]},{label:"Trees",count:t.filter(Nt=>Nt.type==="tree").length,color:bn.tree[0]},{label:"Parking",count:t.filter(Nt=>Nt.type==="parking").length,color:bn.parking[0]},{label:"Labels",count:t.filter(Nt=>Nt.type==="label").length,color:bn.label[0]}],_t=document.createElementNS(qe,"text");_t.setAttribute("x",`${b}`),_t.setAttribute("y",`${Ke}`),_t.setAttribute("font-size","12"),_t.setAttribute("font-weight","600"),_t.setAttribute("fill","#0f172a"),_t.textContent="Legend",ve.appendChild(_t),mt.forEach((Nt,oi)=>{const ir=b+oi*150,zn=document.createElementNS(qe,"rect");zn.setAttribute("x",`${ir}`),zn.setAttribute("y",`${Ke+14}`),zn.setAttribute("width","10"),zn.setAttribute("height","10"),zn.setAttribute("rx","2"),zn.setAttribute("fill",Nt.color),ve.appendChild(zn);const Ci=document.createElementNS(qe,"text");Ci.setAttribute("x",`${ir+16}`),Ci.setAttribute("y",`${Ke+23}`),Ci.setAttribute("font-size","11"),Ci.setAttribute("fill","#475569"),Ci.textContent=`${Nt.label} (${Nt.count})`,ve.appendChild(Ci)})}const Ze=document.createElement("canvas"),Se=Ze.getContext("2d");Ze.width=Ee*_,Ze.height=Ge*_,Se&&Se.scale(_,_);const et=new XMLSerializer().serializeToString(ve),it=new Image,xt=new Blob([et],{type:"image/svg+xml;charset=utf-8"}),ut=URL.createObjectURL(xt);it.onload=()=>{if(Se){Se.fillStyle="#ffffff",Se.fillRect(0,0,Ee,Ge),Se.drawImage(it,0,0);const Ke=Ze.toDataURL("image/png"),mt=document.createElement("a");mt.href=Ke,mt.download="security_plan.png",document.body.appendChild(mt),mt.click(),document.body.removeChild(mt)}URL.revokeObjectURL(ut)},it.src=ut},K=(_,b,N,B)=>{lt(k=>[...k,{id:crypto.randomUUID(),type:_,label:b,dataUrl:N,cameraId:B}])},q=_=>{var Ze;const B=At(_),k=((Ze=_.mount)==null?void 0:Ze.height)??_.height??10,oe=_.hFov??_.fov,Q=_.pitch??-15,ie=_.range,xe=Un.degToRad(_.rotation),pe=new Dc;pe.background=new wt("#87CEEB"),pe.fog=new Oa("#87CEEB",ie*.3,ie*1.2);const Ee=new ei(oe,640/480,1,ie*2);Ee.position.set(B.x,k,B.y);const Ge=Un.degToRad(Q),qe=new U(B.x+Math.cos(xe)*100,k+Math.tan(Ge)*100,B.y+Math.sin(xe)*100);Ee.lookAt(qe),pe.add(new nf(16777215,.5));const ve=new tf(16777215,.7);ve.position.set(100,200,50),pe.add(ve);const be=new Ye(new xi(v.width*2,v.height*2),new cn({color:"#6B8E23",roughness:.9}));if(be.rotation.x=-Math.PI/2,be.position.set(v.width/2,0,v.height/2),pe.add(be),pt.current){const Se=new qd(pt.current);Se.colorSpace=$t;const et=new Ye(new xi(m.width,m.height),new Ji({map:Se,transparent:!0,opacity:m.opacity}));et.rotation.x=-Math.PI/2,et.position.set(m.x+m.width/2,.1,m.y+m.height/2),pe.add(et)}t.forEach(Se=>{if(Se.type==="building"){const et=Se,it=O(et),xt=new gs(it.map(mt=>new Me(mt.x,-mt.y))),ut=new Ba(xt,{depth:60,bevelEnabled:!1});ut.rotateX(-Math.PI/2);const Ke=new Ye(ut,new cn({color:et.color,side:ui}));Ke.position.set(et.x,0,et.y),Ke.rotation.y=-Un.degToRad(et.rotation),pe.add(Ke)}if(Se.type==="tree"){const et=cf(Se);pe.add(et)}if(Se.type==="parking"){const et=lf(Se);pe.add(et)}});const ce=document.createElement("canvas");ce.width=640,ce.height=480;const Re=new Ic({canvas:ce,antialias:!0});Re.setSize(640,480),Re.render(pe,Ee);const ye=ce.getContext("2d");if(ye){ye.fillStyle="rgba(0,0,0,0.7)",ye.fillRect(0,0,640,30),ye.fillStyle="#fff",ye.font="bold 14px sans-serif",ye.fillText(`📷 ${_.label}`,10,20),ye.font="12px sans-serif",ye.fillStyle="#94a3b8";const Se=`FOV: ${oe.toFixed(0)}° | Pitch: ${Q}° | Range: ${ie}px`;ye.fillText(Se,640-ye.measureText(Se).width-10,20)}const ke=ce.toDataURL("image/png");return Re.dispose(),ke},Fe=()=>{if(!he.current)return;const _=new XMLSerializer().serializeToString(he.current),b=document.createElement("canvas");b.width=v.width*2,b.height=v.height*2;const N=b.getContext("2d");if(!N)return;const B=new Image,k=new Blob([_],{type:"image/svg+xml;charset=utf-8"}),oe=URL.createObjectURL(k);B.onload=()=>{N.scale(2,2),N.fillStyle="#f8fafc",N.fillRect(0,0,v.width,v.height),N.drawImage(B,0,0),K("plan","2D Plan View",b.toDataURL("image/png")),URL.revokeObjectURL(oe)},B.src=oe},Qe=_=>{const b=q(_);K("camera",`Camera: ${_.label}`,b,_.id)},ot=_=>{var B;const b=(B=_.target.files)==null?void 0:B[0];if(!b)return;const N=new FileReader;N.onload=k=>{var ie;const oe=(ie=k.target)==null?void 0:ie.result,Q=new Image;Q.onload=()=>{const xe=Q.width/Q.height,pe=xe>=1.8&&xe<=2.2;dt(oe),Ve(pe?"panorama":"flat")},Q.src=oe},N.readAsDataURL(b)},ft=async()=>{if(Ue.length===0){alert("Add some views to the export list first!");return}const _=2,b=40,N=800,B=600,k=2,oe=Math.ceil(Ue.length/k),Q=(N+b)*k+b,ie=120,xe=ie+(B+b+30)*oe+b,pe=document.createElement("canvas");pe.width=Q*_,pe.height=xe*_;const Ee=pe.getContext("2d");if(!Ee)return;Ee.scale(_,_),Ee.fillStyle="#fff",Ee.fillRect(0,0,Q,xe),Ee.fillStyle="#0f172a",Ee.font="bold 28px sans-serif",Ee.fillText(T||"Security Camera Plan",b,b+30),Ee.fillStyle="#64748b",Ee.font="14px sans-serif",Ee.fillText(`Exported: ${new Date().toLocaleString()} | ${Ue.length} view(s)`,b,b+55);const Ge=be=>new Promise((ce,Re)=>{const ye=new Image;ye.onload=()=>ce(ye),ye.onerror=Re,ye.src=be});for(let be=0;be<Ue.length;be++){const ce=Ue[be],Re=be%k,ye=Math.floor(be/k),ke=b+Re*(N+b),Ze=ie+ye*(B+b+30);Ee.fillStyle="#334155",Ee.font="bold 14px sans-serif",Ee.fillText(ce.label,ke,Ze+20),Ee.fillStyle="#f1f5f9",Ee.fillRect(ke,Ze+28,N,B),Ee.strokeStyle="#e2e8f0",Ee.lineWidth=2,Ee.strokeRect(ke,Ze+28,N,B);try{const Se=await Ge(ce.dataUrl),et=Se.width/Se.height,it=N/B;let xt,ut,Ke,mt;et>it?(xt=N,ut=N/et,Ke=ke,mt=Ze+28+(B-ut)/2):(ut=B,xt=B*et,Ke=ke+(N-xt)/2,mt=Ze+28),Ee.drawImage(Se,Ke,mt,xt,ut)}catch{Ee.fillStyle="#cbd5e1",Ee.font="16px sans-serif",Ee.fillText("Failed to load image",ke+20,Ze+100)}}const qe=pe.toDataURL("image/png"),ve=document.createElement("a");ve.href=qe,ve.download=`${(T||"security_plan").replace(/\s+/g,"_")}_report.png`,document.body.appendChild(ve),ve.click(),document.body.removeChild(ve)},yt=()=>{if(Ue.length===0){alert("Add some views to the export list first!");return}const _=window.open("","_blank");if(!_){alert("Please allow popups to export PDF");return}const b=`
      <!DOCTYPE html>
      <html>
      <head>
